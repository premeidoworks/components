...
type AcquireRequest struct {
	Queue string `protobuf:"bytes,1,req,name=queue" json:"queue"`
}
...
func (m *AcquireRequest) GetQueue() string {
	if m != nil {
		return m.Queue
	}
	return ""
...
type AcquireResponse struct {
	MessageList []*Message `protobuf:"bytes,1,rep,name=messageList" json:"messageList,omitempty"`
}
...
func (m *AcquireResponse) GetMessageList() []*Message {
	if m != nil {
		return m.MessageList
	}
	return nil
...
func init() {
	...
	proto.RegisterType((*AcquireRequest)(nil), "kanatasupport.AcquireRequest")
	proto.RegisterType((*AcquireResponse)(nil), "kanatasupport.AcquireResponse")
}
...
var fileDescriptor_33c57e4bae7b9afd = []byte{
	...
	,
}
...
func (this *AcquireRequest) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&kanatasupport.AcquireRequest{")
...
func (this *AcquireResponse) GoString() string {
	...
	s := make([]string, 0, 5)
	s = append(s, "&kanatasupport.AcquireResponse{")
	if this.MessageList != nil {
		s = append(s, "MessageList: "+fmt.Sprintf("%#v", this.MessageList)+",\n")
	}
	s = append(s, "}")
...
func (m *AcquireRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0xa
	i++
	i = encodeVarintMessage(dAtA, i, uint64(len(m.Queue)))
...
func NewPopulatedAcquireRequest(r randyMessage, easy bool) *AcquireRequest {
	this := &AcquireRequest{}
	this.Queue = string(randStringMessage(r))
	if !easy && r.Intn(10) != 0 {
	}
	return this
}

func NewPopulatedAcquireResponse(r randyMessage, easy bool) *AcquireResponse {
	this := &AcquireResponse{}
	if r.Intn(10) != 0 {
		v14 := r.Intn(5)
		this.MessageList = make([]*Message, v14)
		for i := 0; i < v14; i++ {
			this.MessageList[i] = NewPopulatedMessage(r, easy)
		}
	}
...
func (m *AcquireRequest) Unmarshal(dAtA []byte) error {
	...
	if hasFields[0]&uint64(0x00000001) == 0 {
		return github_com_gogo_protobuf_proto.NewRequiredNotSetError("queue")
	}
